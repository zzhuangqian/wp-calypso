...
class DeleteSite extends Component {
	...
	componentWillReceiveProps( nextProps ) {
		const { isDeletingSite: previousIsDeletingSite } = this.props;
		const { isDeletingSite: nextIsDeletingSite } = nextProps;

		if ( previousIsDeletingSite && ! nextIsDeletingSite ) {
